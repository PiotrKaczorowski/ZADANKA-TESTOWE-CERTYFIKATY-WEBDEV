...
Type: PUBLIC
Given the following data definition, select all queries that return the second 
largest salary. Note that it is possible that some employees have the same salary.
...
TABLE emp
    ...
    SELECT DISTINCT salary FROM emp WHERE 1=1 ORDER BY salary ASC LIMIT 1


If we have employees A, B, and C whose salaries are $100, $80, and $100 respectively,
note that the second highest salary is $80 although there are two employees with a higher salary.
